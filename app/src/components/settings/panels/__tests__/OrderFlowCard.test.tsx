 ...
 *   5. Alert toggle — checkbox calls order_flow_set_config with toggled value
  ...
  it('calls order_flow_apply_preset and shows success message', async () => {
    ...
    await waitFor(() => {
      expect(mockInvoke).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ name: 'vwap_profile_anchored' })
      );
...
describe('Detection alerts', () => {
  it('calls order_flow_set_config when an alert toggle is clicked', async () => {
    renderCard(true);
