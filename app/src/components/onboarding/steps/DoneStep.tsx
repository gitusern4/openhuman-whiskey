 ...
 * Step 4 — All set.
 *
 * Summary card listing the choices made + a CTA button.
 *
 * TODO: retarget the CTA to `/settings/tks-mods` once TK's Mods lands
 * from its parallel branch. For now it routes to `/settings/modes` because
 * that route is confirmed to exist on the `whiskey` branch HEAD.
 */
